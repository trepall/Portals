...
async def start(message: types.Message):
    ...
    # Кнопка открытия мини-приложения прямо в Telegram
    kb.button(
        text="🚀 Открыть в мини-приложении",
        web_app=types.WebAppInfo(url="https://trepall.github.io/Portal-market/")  # URL мини-приложения
    )
    
    # Кнопка поддержки
    kb.button(
        text="💬 Поддержка",
        url="https://t.me/MarketSuportGift"
    )
    
    kb.adjust(1)  # каждая кнопка в отдельной строке
